...
| | 12 | **Ready-to-Arm Wiggle** | Arming 준비 완료 시 에일러론 타면을 흔들어 시각적 알림 |
...
| ShuttleDistance | 셔틀 왕복 거리 | Roll F |
| ShuttleCount | 셔틀 왕복 횟수 | Roll d_min |
| AscendPitch | 상승 피치각 | Pitch P |
| MidPitch | 순항 피치각 | Pitch I |
| LandingPitch | 착륙 피치각 | Pitch D |
| AltholdGain | 고도 유지 P게인 | Pitch F |
| LandingSpeed | 착륙 속도 | Pitch d_min |
| SBankGain | 셔틀 선회 강도 | Yaw P |
| SBankPitchGain | 셔틀 선회 피치 보정 | Yaw I |
| descentAlt | 하강 종료 고도 | Yaw D |
| HeadingYawGain | 미세요 게인 | Yaw F |
| landingAlt | 착륙 고도 | Yaw d_min |
